...
const list = {
  ...
  notes: [
    ...
    `This list will be progressively updated and improved, I just wanted to release something useful quickly. Expect small daily updates. Please report mistakes using the feedback button.`,
